...
<body>
<%@include file="/resources/pages/Trainee/TraineeLogin.jsp"%>
<%@include file="/resources/pages/TrainingProvider/TrainingProviderLogin.jsp"%>
<%@include file="/resources/pages/FreeLancer/FreelancerLogin.jsp" %>
	<div id="pop_up_box_6">
		<a class="b-close"><img
