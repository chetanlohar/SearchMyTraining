...
insert  into `tbl_contcatinfomaster`(`contctinfoId`,`emailId`,`website`,`cntcPersName`,`userId`) values (1,'aaa@bbb.com','softinfology.com','Chetan Lohar',158),(2,'aaa@bbb.com','softinfology.com','Chetan Lohar',158),(3,'ababa@gmail.com','www.softinfology.com','chetan lohar',160),(4,'ababa@gmail.com','www.softinfology.com','chetan lohar',160),(5,'ababa@gmail.com','www.softinfology.com','chetan lohar',160);
...
insert  into `tbl_freelancerregdetails`(`freelancerId`,`fullName`,`city`,`contact`,`email`,`userId`) values (2,'chetan lohar',NULL,'8446448344','a@bbb.com',164),(3,'asdfasdf',NULL,'3213213213','a@b.com',165),(4,'Chetan Lohar',NULL,'8446448344','a@b.com',167);
...
insert  into `tbl_instprofiledetails`(`compInfoId`,`companyName`,`yrofEstablmnt`,`historyOfCompany`,`hrsOfOpertn`,`workingDays`,`trngMethodology`,`userId`) values (1,'Softinfology',1991,'nice','9 am to 7 pm','MON, TUE, WED, THU, FRI, SAT','Online and Offline',156),(2,'Seed Infotech',1998,'nice ','9 am to 7 pm','MON, TUE, WED, THU, FRI, SAT','Online and Offline',159);
...
insert  into `tbl_keyclients`(`keyClientId`,`clientName`,`userId`) values (1,'TCS',156),(2,'rrrr',156),(3,'vvvv',156),(4,'dsasa',159),(5,'dsasa',159),(6,'dasda',159);
...
insert  into `tbl_locainfodetails`(`locDetialsId`,`buildingNo`,`street`,`landmark`,`pincode`,`cityId`,`userId`) values (1,'123123','sdfasdfasf','sadfasdfasdf',123123,1,160),(2,'123123','sdfasdfasf','sadfasdfasdf',123123,1,160);
...
insert  into `tbl_phonedetails`(`phoneId`,`phnTypeId`,`userId`,`phoneValue`) values (1,1,158,'8446448344'),(3,1,158,'8446448342'),(4,NULL,158,'123123232323'),(6,4,160,'8446448341'),(7,4,160,'8446448340'),(8,4,160,'8446448349');
...
insert  into `tbl_profesnlassociation`(`asscoId`,`assocName`,`userId`) values (1,'abc INC.',NULL),(2,'xyz Inc.',NULL),(3,'pqr INC',NULL),(4,'sdfsdf',NULL),(5,'safsdf',NULL),(6,'sdfasdf',NULL),(7,'asdfsdfa',156),(8,'asdfasdf',156);
...
insert  into `user_attempts`(`USERID`,`ATTEMPTS`,`LASTMODIFIED`) values (168,0,'2015-06-16 19:04:59');
...
insert  into `user_roles`(`USER_ROLE_ID`,`USERID`,`ROLE`) values (7,143,'TPF'),(19,160,'TPF'),(20,161,'TPF'),(21,162,'TPF'),(23,164,'TPF'),(24,165,'TPF'),(26,167,'TPF'),(8,144,'TPI'),(9,149,'TPI'),(10,150,'TPI'),(11,152,'TPI'),(12,153,'TPI'),(13,154,'TPI'),(14,155,'TPI'),(15,156,'TPI'),(18,159,'TPI'),(25,166,'TPI'),(27,168,'TPI'),(28,169,'TPI'),(29,170,'TPI'),(30,171,'TPI'),(16,157,'TRAINEE'),(17,158,'TRAINEE');
...
insert  into `users`(`userId`,`username`,`password`,`enabled`,`accountNonExpired`,`accountNonLocked`,`credentialsNonExpired`,`created_on`,`created_by`,`Modified_on`,`Modified_by`,`statusId`) values (143,'a@b.com','$2a$10$7tBa/DVauFVDW9nI5Ppd5ONEj5QRkzpqSOza3jJelFu5iAF2bnqci',1,1,1,1,'2015-06-03 17:28:41','SELF','2015-06-03 17:28:41','SELF',1),(144,'a@bb.com','$2a$10$5hsNlfUI0bv2oKfzSgRx5.J/yN.W1L/5zCmaBtcQcWn2MmTI0FRDO',1,1,1,1,'2015-06-03 18:21:35','SELF','2015-06-03 18:21:35','SELF',1),(149,'at@jati.com','$2a$10$BRflaVgztiQOhzLfiWVkzOQk0pQQYVQ.Lao.Os5V7alPRnQBxXkbK',1,1,1,1,'2015-06-03 18:31:33','SELF','2015-06-03 18:31:33','SELF',1),(150,'p@c.om','$2a$10$X.cpZRDh2YVqt3DnK2I0XuM28febiEPK.jYtQIRF/Pmr40PhKsz3y',1,1,1,1,'2015-06-03 18:33:45','SELF','2015-06-03 18:33:45','SELF',1),(152,'abc@gmail.com','$2a$10$QxV/QwyCXr3HA9pOD1SPUu8REvZhwdng0S2P7srUqLS67VtG1mlvK',1,1,1,1,'2015-06-03 18:35:15','SELF','2015-06-03 18:35:15','SELF',1),(153,'rr@dd.com','$2a$10$1Wz2GuuAU3GsO9r7aZzI0.nd7VGZ3VxSzZnFB2FHUjgLeA3gJRwz.',1,1,1,1,'2015-06-03 18:35:36','SELF','2015-06-03 18:35:36','SELF',1),(154,'aa@vv.com','$2a$10$5WxqOXbTf7jtgSB2Ord3m.PC/nNOq9Ct9Q1CqTNiyxqMegYLaXzke',1,1,1,1,'2015-06-06 15:05:12','SELF','2015-06-06 15:05:12','SELF',1),(155,'abc@gmail.com','$2a$10$yFSAHaieKC7Q1H3gr0EUtuxYovH1eI.k2kJuv88vLyK9Xfvkmh.fW',1,1,1,1,'2015-06-09 12:34:28','SELF','2015-06-09 12:34:28','SELF',1),(156,'abc@ggmail.com','$2a$10$2Xi0v7QAE0OgtF3s8Le7ou9t6uwmNLVLvMlmF3j74cfcRMec3RXCy',1,1,1,1,'2015-06-09 12:43:25','SELF','2015-06-09 12:43:25','SELF',1),(157,'chetan@gmail.com','$2a$10$gErw9lQdH1.C5d7js83nyOCYx0TQh1dWtJJ6k8YBDQbztYJYi0pnm',1,1,1,1,'2015-06-09 17:43:16','SELF','2015-06-09 17:43:16','SELF',1),(158,'abc@gmail.com','$2a$10$FVPmDfESrxGW3oxChQcwyObcBwdT4kCd2VqzafJN7eWHjpgT.MQTi',1,1,1,1,'2015-06-09 17:48:31','SELF','2015-06-09 17:48:31','SELF',1),(159,'abcc@rg.com','$2a$10$La4BSQ0QNEYH9hHmp2J86esOaSqlyca9qp1uNbp7MtbJb.elgnjm6',1,1,1,1,'2015-06-09 17:57:20','SELF','2015-06-09 17:57:20','SELF',1),(160,'ababa@gmail.com','$2a$10$uXCki.bc8wN7B3ww56K5b.9jVM5HqldtbM2j8rsws5HxyyB5QHcm2',1,1,1,1,'2015-06-09 18:11:06','SELF','2015-06-09 18:11:06','SELF',1),(161,'a@bbnb.com','$2a$10$6Bkh/hgLwopUnLDO8XGsG.tkcT1t6A9aAYxiQu2LCP.fv8CmCjMzK',1,1,1,1,'2015-06-09 18:38:07','SELF','2015-06-09 18:38:07','SELF',1),(162,'a@bb.com','$2a$10$cz1rxv5JhZrwzXNFqVnrA.h3DJ9E64XHJy0KDdhEClj46wUt/Zfbi',1,1,1,1,'2015-06-10 11:50:24','SELF','2015-06-10 11:50:24','SELF',1),(164,'a@bbb.com','$2a$10$/FAlfT1A9noGwgSVbIHL3.T49F1/DWSWMc6YUgSoPocu/AlTLhkWW',1,1,1,1,'2015-06-10 15:11:38','SELF','2015-06-10 15:11:38','SELF',1),(165,'a@b.com','$2a$10$xGDiXZPN9dLzYKvwKOJH/.HEIiQVp.njH/O63I0n7p7AR5qseMuZq',1,1,1,1,'2015-06-11 11:17:48','SELF','2015-06-11 11:17:48','SELF',1),(166,'chetan@gmail.com','$2a$10$RyH6bUEdvos4Z0ZzsnC6QOed.XRNXkXQb5FRhErvsZgPaeatpOIhe',1,1,1,1,'2015-06-16 17:35:16','SELF','2015-06-16 17:35:16','SELF',1),(167,'a@b.com','$2a$10$ZzQ3rh02hAIzDiTR4TMhhOmweVbfLbxaPaJ04fzBiR7PtHZ3iveQS',1,1,1,1,'2015-06-16 18:42:20','SELF','2015-06-16 18:42:20','SELF',1),(168,'x@y.com','$2a$10$U1M12QDwdvZ.9ekl2L0B8OHHw0L0mvUWJsiMhKlFqR7OFiigGt2LG',1,1,1,1,'2015-06-16 18:45:33','SELF','2015-06-16 18:45:33','SELF',1),(169,'a@bb.com','$2a$10$ZzfMRGf/WYyr5jYBE79ejeSSSQH5suMFq5MymE4eTwgf12T2dlJUq',1,1,1,1,'2015-06-17 11:12:38','SELF','2015-06-17 11:12:38','SELF',1),(170,'aa@bb.com','$2a$10$fcZZCQqpovtgYqRMDoEF2.31nee/oRivl30HzEr.Jy0fMUIwjQEPe',1,1,1,1,'2015-06-17 12:19:33','SELF','2015-06-17 12:19:33','SELF',1),(171,'q@w.com','$2a$10$RZ16WfXbSDJdRildG.Mz7O30guPvFbjTrKmlzDfoUTJrNTgHEYacK',1,1,1,1,'2015-06-17 12:22:43','SELF','2015-06-17 12:22:43','SELF',1);
