...
<body>
 <div id="pop_up_box_7">
            ...
            <div class="reg_form">
                <div class="head">
                    <img src="<%=request.getContextPath()%>/resources/images/register2.png" alt="register">
                </div>
                <form action="#" name="myform" onsubmit="return (validation());">
                    <h2>Login</h2>

                    <div class="mailto">
                        <input type="email" autocomplete="off"  name="Email" value="" placeholder="Email Id" required="">
                    </div>
                    <div class="password">
                        <input type="password" autocomplete="off" name="Password" value="" placeholder="Password" required="">
                    </div>
