 ...
 ;(function($,window,document){
 	...
 	var pluginName = 'dialogBox',
 		defaults = {
 			...
 			title: '',  //string,
 			content: '',  //string,DOM object,jQuery Object,iframe。
 		...
 		create: function(element){
 			...
 			if(!hasBtn){
 				...
 				if(confirmValue && cancelValue){
 					...
 					dialogHTML[1] = '<div class="dialog-btn"><span class="dialog-btn-cancel">Cancel</span><span class="dialog-btn-confirm">Search</span></div></div></section>';
 				}
 			}
