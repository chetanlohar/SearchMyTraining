...
public class SMTUser implements UserDetails, CredentialsContainer {

	private static final long serialVersionUID = 5467779863392106359L;
	...
	public SMTUser(Long userId, String username, String password,
	...
	public boolean equals(Object rhs) {
		if (rhs instanceof User) {
			return username.equals(((SMTUser) rhs).username);
		}
		return false;
	}
