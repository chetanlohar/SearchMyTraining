...
insert  into `tbl_contcatinfomaster`(`contctinfoId`,`emailId`,`website`,`cntcPersName`,`userId`) values (28,'abc@gmail.com','www.softinfology.com','Chetan Lohar',116),(29,'ch@gmail.com','www.abc.com','Chetan',70),(34,NULL,NULL,'abc def',78);
...
insert  into `tbl_freelancerregdetails`(`freelancerId`,`fullName`,`city`,`contact`,`email`,`password`,`userId`) values (1,'chetan h lohar','Pune','1231231231','a@b.com','123',NULL);
...
insert  into `tbl_keyclients`(`keyClientId`,`clientName`,`userId`) values (1,'Capegemini',70),(2,'TCS',70),(3,'Accenture',70);
...
insert  into `tbl_locainfodetails`(`locDetialsId`,`buildingNo`,`street`,`landmark`,`pincode`,`cityId`,`userId`) values (6,'Sr No. 11/19','Hadapsar Bypass Road','ICICI Bank',411014,1,116),(7,'Sr No. 11/19','Hadapsar Bypass','ICICI Bank',411014,1,70);
...
insert  into `tbl_phonedetails`(`phoneId`,`phnTypeId`,`userId`,`phoneValue`) values (26,1,116,'8446448344'),(27,1,70,'8585858585'),(28,2,78,NULL);
...
insert  into `tbl_phonetypemaster`(`phnTypeId`,`phnTypeName`) values (1,'Mob-Off'),(2,'Mob-Personal'),(3,'landline-Off'),(4,'Landline-Personal'),(5,'Fax'),(6,'Toll Free');
...
insert  into `tbl_profesnlassociation`(`asscoId`,`assocName`,`userId`) values (1,'abc INC.',70),(2,'xyz Inc.',70),(3,'pqr INC',70);
